...
/**
 * By default we don't need anything from the events from the Tor Event Handler so we just log them here.
 * This code is adapted from TorPlugin's EventHandler methods.
 */
public class LoggingEventHandler implements EventHandler {
    ...
    public void message(String severity, String msg) {
        ...
        if(severity.equals("NOTICE") && msg.startsWith("Bootstrapped 100%")) {
            // In the OnionProxyManager code bootstrapped is set to true when start is called and it's never
            // touched again so this call (when it was part of that code, before I refactored it) was largely
            // redundant. But this seems useful.
            // TODO: Figure out what to do about boostrapped
            //bootstrapped = true;
        }
    }
