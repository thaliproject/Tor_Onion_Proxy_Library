...
public abstract class OnionProxyManager {
    ...
    public OnionProxyManager(OnionProxyContext onionProxyContext, EventHandler eventHandler) {
        ...
        torDirectory = new File(onionProxyContext.getWorkingDirectory(), "tor");
        ...
        this.eventHandler = eventHandler == null ? new LoggingEventHandler() : eventHandler;
    }
        ...
        if(!hostnameFile.exists()) {
            ...
            try {
                ...
                if (hostnameFile.getParentFile().exists() == false && hostnameFile.getParentFile().mkdirs() == false) {
                    throw new RuntimeException("Could not create directory for hostnameFile");
                }
